...
#define CONFIGURATION_H_VERSION 25082020(rev 1.0)
...
#define STRING_CONFIG_H_AUTHOR "(Manoel Guilherme Moraes )" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Custom ROM TMP"
